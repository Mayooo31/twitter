    ...
    <EmptyLayout>
      <div className="w-full h-screen bg-black flex flex-col items-center justify-center">
        ...
        <div className="max-w-[300px] w-full">
          <h1 className="text-2xl sm:text-3xl font-bold mb-7">Přihlaste se na Twitter</h1>
          <button className="bg-white hover:bg-opacity-80 ease-in-out duration-150 text-black w-full py-2 rounded-full">
          ...
          <button
            type="submit"
            className="w-full border-solid border-[1px] border-white rounded-full py-2 hover:bg-[#0b0b0b]"
          >
