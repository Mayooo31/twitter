...
const NavigationPanel = () => {
  ...
  return (
    ...
    >
      ...
      <button className="h-full xs:h-[55px] w-[25%] xs:w-full py-3 xs:py-0 center justify-center flex xs:justify-center xs:items-center lg:justify-start lg:gap-5 lg:w-fit hover:bg-[#ffffff1e] lg:pl-3 lg:pr-6 lg:rounded-full">
        {selected === "home" ? (
