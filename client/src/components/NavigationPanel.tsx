...
const NavigationPanel = () => {
  ...
  return (
    <div
      className={`bg-[#15202b] z-50 fixed bottom-0 left-0 xs:h-full w-full xs:w-[70px] flex xs:flex-col justify-around xs:justify-start items-center border-t-[#d2d2d248] border-t-[1px] border-solid xs:border-t-[0px] xs:border-r-[1px] xs:border-r-[#d2d2d248] ss:static ss:h-screen lg:w-[250px] lg:items-start`}
    >
      ...
      <button className="h-full xs:h-[55px] w-[25%] xs:w-full py-3 xs:py-0 center justify-center flex xs:justify-center xs:items-center lg:justify-start lg:gap-5 lg:w-fit lg:hover:bg-[#ffffff1e] lg:pl-3 lg:pr-6 lg:rounded-full">
        {selected === "home" ? (
      ...
      <button className="hidden h-full xs:h-[55px] center lg:flex xs:items-center lg:justify-start lg:gap-5 lg:w-fit lg:hover:bg-[#ffffff1e] lg:pl-3 lg:pr-6 lg:rounded-full">
        {selected === "home" ? (
      ...
      {/* NO LG END */}
      <button className="h-full xs:h-[55px] w-[25%] xs:w-full py-3 xs:py-0 center flex xs:justify-center xs:items-center lg:justify-start lg:gap-5 lg:w-fit lg:hover:bg-[#ffffff1e] lg:pl-3 lg:pr-6 lg:rounded-full justify-center">
        {selected === "bell" ? (
      ...
      <button className="hidden  xs:h-[55px] xs:w-full xs:py-0 center xs:flex xs:justify-center xs:items-center lg:justify-start lg:gap-5 lg:w-fit lg:hover:bg-[#ffffff1e] lg:pl-3 lg:pr-6 lg:rounded-full">
        {selected === "bookmark" ? (
